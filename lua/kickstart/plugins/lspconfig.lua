return {
  {
    ...
    dependencies = {
      ...
      { 'williamboman/mason.nvim', config = true, ensure_installed = { 'prettier' } }, -- NOTE: Must be loaded before dependants
    ...
    config = function(_, opts)
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          map('<leader>ds', require('telescope.builtin').treesitter, '[D]ocument [S]ymbols (Treesitter)')
